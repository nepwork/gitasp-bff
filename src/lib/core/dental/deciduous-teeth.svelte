<script lang="ts">
	...
	$: console.log("toothIndex", toothIndex, tl.currentDeciduousTooth);

	const currentTooth = () => tl.teethDescription;

	function selectedToothIso(i: number) {
		tl.selectedToothIso(i);
		toothIndex = i;
	}
...
<div class="grid grid-cols-2">
	<div class="p-teeth text-black font-normal min-h-[400px]">
			<h1 class="text-2xl font-semibold pl-14 pb-4">Deciduous Teeth</h1>
			<svg version="1.1" xmlns="http://www.w3.org/2000/svg" 
					preserveAspectRatio="xMidYMid meet" viewBox="0 0 560 640" class="svgContainer font-thin">
					<defs>
							<path class="tooth"
									...
									id="iso-51" />
							<path class="tooth" d="M268.14 35.87C256.58 30.99 244.5 32.69 231.56 42.92" id="a3GVDWJbDP" />
							<path class="tooth"
									...
									id="iso-52" />
							<path class="tooth" d="M203.98 57.36C195.15 57.99 187.9 57.2 177.49 70.46" id="c1vrzH7GD" />
							<path class="tooth"
									...
									id="iso-53" />
							<path class="tooth" d="M154.74 98.87C134.65 102.43 131.01 118.38 129.96 129.93" id="b2KyfohhGJ" />
							<path class="tooth"
							...
							<path class="tooth"
									...
									id="a882cHHUnK" />
							<text id="akcTcyEBf" x="214.21" y="10.52" font-size="45"
							...
							<path class="tooth"
									...
									id="cwHRvgNcf" />
							<text id="b1QRjJGSJn" x="214.21" y="10.52" font-size="45"
									transform="matrix(1 0 0 1 28.026439084936285 179.44872859690972)">
									<tspan x="214.21" dy="0em" dominant-baseline="text-before-edge" />
							</text>
							<text id="aQ4GDm7Nj" x="214.21" y="10.52" font-size="45"
									transform="matrix(1 0 0 1 45.182689084936285 195.07372859690972)">
									<tspan x="214.21" dy="0em" dominant-baseline="text-before-edge" />
							</text>
							<text id="c1Am1SRnuf" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 9.499999999999972 -13.818655303030482)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(51) ? '#212121' : '#000'}>
											51
									</tspan>
							</text>
							<text id="a1wTSzo241" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 -27.54545454545476 -3.3489583333335986)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(52) ? '#212121' : '#000'}>
											52
									</tspan>
							</text>
							<text id="dngiuIzIj" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 -60.114216486779355 29.63351517487976)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(53) ? '#212121' : '#000'}>
											53
									</tspan>
							</text>
							<text id="aPscZuMW" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 -71.54390398677936 81.17930349069081)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(54) ? '#212121' : '#000'}>
											54
									</tspan>
							</text>
							<text id="evESRjLHU" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 -73.54390398677938 163.84957592658844)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(55) ? '#212121' : '#000'}>
											55
									</tspan>
							</text>
							<path class="tooth"
									...
									id="iso-61" />
							<path class="tooth" d="M326.46 35.87C338.02 30.99 350.11 32.69 363.05 42.92" id="h1eFc4drSD" />
							<path class="tooth"
									...
									id="iso-62" />
							<path class="tooth" d="M390.63 57.36C399.45 57.99 406.71 57.2 417.12 70.46" id="f8TlGPwTJ" />
							<path class="tooth"
									...
									id="iso-63" />
							<path class="tooth" d="M439.87 98.87C459.96 102.43 463.6 118.38 464.65 129.93" id="a4D4emNiDi" />
							<path class="tooth"
							...
							<path class="tooth"
									...
									id="d9AQUN9l" />
							<text id="c2wMTLwFKC" x="214.21" y="10.52" font-size="45"
							...
							<path class="tooth"
									...
									id="g9i5HslOD" />
							<text id="a3vLld1187" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 80.0303030303032 -16.8489583333336)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(61) ? '#212121' : '#000'}>
											61
									</tspan>
							</text>
							<text id="d8C077TiQe" x="241.89" y="100.29" font-size="20"
									...
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(62) ? '#212121' : '#000'}>
											62
									</tspan>
							</text>
							<text id="a3dsbSynl2" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 147.53030303030368 32.74195075757564)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(63) ? '#212121' : '#000'}>
											63
									</tspan>
							</text>
							<text id="c3i2cqy5i8" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 154.65196824741906 71.6076251690125)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(64) ? '#212121' : '#000'}>
											64
									</tspan>
							</text>
							<text id="c2Gq2EB8T" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 154.651968247419 163.84957592658844)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(65) ? '#212121' : '#000'}>
											65
									</tspan>
							</text>
							<path class="tooth"
									...
									id="iso-81" />
							<path class="tooth" d="M268.73 613.87C261.31 618.51 253.22 617.56 244.15 609.37" id="baO5m8gAJ" />
							<path class="tooth"
									...
									id="iso-82" />
							<path class="tooth" d="M216.13 601.56C207.72 601.46 200.88 602.68 190.24 590.06" id="b1OuMQtEP6" />
							<path class="tooth"
									...
									id="iso-83" />
							<path class="tooth" d="M169.04 563.56C149.77 561.2 145.41 545.49 143.76 534.03" id="b2roP7vEXi" />
							<path class="tooth"
							...
							<path class="tooth"
									...
									id="a5EcJWHaOD" />
							<text id="a1jKNA7rAN" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 9.128496503496507 445.10453088578424)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(81) ? '#212121' : '#000'}>
											81
									</tspan>
							</text>
							<text id="aAHeijBe5" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 -25.137128496503493 430.50453088578445)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(82) ? '#212121' : '#000'}>
											82
									</tspan>
							</text>
							<text id="ek5cw6Hgp" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 -53.026333041958225 396.11494755245076)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(83) ? '#212121' : '#000'}>
											83
									</tspan>
							</text>
							<text id="g2rNJx6rxS" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 -66.3451977036963 352.9505417835022)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(84) ? '#212121' : '#000'}>
											84
									</tspan>
							</text>
							<text id="d14UMdDj6N" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 -71.62851406792367 265.32019716321423)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(85) ? '#212121' : '#000'}>
											85
									</tspan>
							</text>
							<path class="tooth"
									...
									id="iso-71" />
							<path class="tooth" d="M320.14 613.87C327.56 618.51 335.65 617.56 344.71 609.37" id="f1SexwZEcq" />
							<path class="tooth"
									...
									id="iso-72" />
							<path class="tooth" d="M372.73 601.56C381.14 601.46 387.98 602.68 398.62 590.06" id="b9tcVaTZ" />
							<path class="tooth"
									...
									id="iso-73" />
							<path class="tooth" d="M419.82 563.56C439.09 561.2 443.45 545.49 445.1 534.03" id="hdg0tmh2L" />
							<path class="tooth"
							...
							<path class="tooth"
									...
									id="a4VwzCcbws" />
							<text id="a253G7JNHZ" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 72.42849650349658 445.10453088578436)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(71) ? '#212121' : '#000'}>
											71
									</tspan>
							</text>
							<text id="dgSWNXQt1" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 135.69999271561827 396.11494755245076)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(72) ? '#212121' : '#000'}>
											73
									</tspan>
							</text>
							<text id="b1fKZ8Bv2u" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 110.36287150349685 430.50453088578445)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(73) ? '#212121' : '#000'}>
											72
									</tspan>
							</text>
							<text id="b83Atca9Z" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 147.12968021561827 350.3920846156701)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(74) ? '#212121' : '#000'}>
											74
									</tspan>
							</text>
							<text id="hfHo0NDB3" x="241.89" y="100.29" font-size="20"
									transform="matrix(1 0 0 1 154.3272936186599 258.43678158536613)">
									<tspan x="241.89" dy="0em" dominant-baseline="text-before-edge"
											stroke={tl.shouldBeStroked(75) ? '#212121' : '#000'}>
											75
									</tspan>
							</text>
					</defs>
					<g class="main">
							<g class="q5">
									<g class="1" on:click={() => selectedToothIso(51)} >
											<g>
													<use xlink:href="#iso-51" fill={tl.conditionToColor( tl.getByIso(51))} />
													<g>
															<use xlink:href="#iso-51" fill-opacity="0" stroke={"#000"} stroke-width="2">
													</g>
											</g>
											<g>
													<use xlink:href="#a3GVDWJbDP" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#a3GVDWJbDP" fill-opacity="0" stroke="#000" stroke-width="2">
													</g>
											</g>
									</g>
									<g class="2" on:click={() => selectedToothIso(52)}>
											<g>
													<use xlink:href="#iso-52" fill={tl.conditionToColor( tl.getByIso(52))} />
													<g>
															<use xlink:href="#iso-52" fill-opacity="0" stroke="#000" stroke-width="2">
													</g>
											</g>
											<g>
													<use xlink:href="#c1vrzH7GD" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#c1vrzH7GD" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="3" on:click={() => selectedToothIso(53)}>
											<g>
													<use xlink:href="#iso-53" fill={tl.conditionToColor( tl.getByIso(53))} />
													<g>
															<use xlink:href="#iso-53" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#b2KyfohhGJ" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#b2KyfohhGJ" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="4" on:click={() => selectedToothIso(54)}>
											<g>
													<use xlink:href="#iso-54" fill={tl.conditionToColor( tl.getByIso(54))} />
													<g>
															<use xlink:href="#iso-54" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#cwHRvgNcf" opacity="1" fill="#000" />
													<g>
															<use xlink:href="#cwHRvgNcf" fill-opacity="0" stroke="#000" stroke-width="0" >
													</g>
											</g>
									</g>
									<g class="5" on:click={() => selectedToothIso(55)}>
											<g>
													<use xlink:href="#iso-55" fill={tl.conditionToColor( tl.getByIso(55))} />
													<g>
															<use xlink:href="#iso-55" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#a882cHHUnK" opacity="1" fill="#000" />
													<g>
															<use xlink:href="#a882cHHUnK" fill-opacity="0" stroke="#000" stroke-width="0" >
													</g>
											</g>
									</g>
									<g class="text">
											<g id="ch2ZdTfb">
													<use xlink:href="#c1Am1SRnuf" opacity="1" fill="#000" />
											</g>
											<g id="aVfNqKx3C">
													<use xlink:href="#a1wTSzo241" opacity="1" fill="#000" />
											</g>
											<g id="c14SVdlY4">
													<use xlink:href="#dngiuIzIj" opacity="1" fill="#000" />
											</g>
											<g id="b17vJJzkit">
													<use xlink:href="#aPscZuMW" opacity="1" fill="#000" />
											</g>
											<g id="bUzQYBN8P">
													<use xlink:href="#evESRjLHU" opacity="1" fill="#000" />
											</g>
									</g>
							</g>
							<g class="g6">
									<g class="1" on:click={() => selectedToothIso(61)}>
											<g>
													<use xlink:href="#iso-61" fill={tl.conditionToColor( tl.getByIso(61))} />
													<g>
															<use xlink:href="#iso-61" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#h1eFc4drSD" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#h1eFc4drSD" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="2" on:click={() => selectedToothIso(62)}>
											<g>
													<use xlink:href="#iso-62" fill={tl.conditionToColor( tl.getByIso(62))} />
													<g>
															<use xlink:href="#iso-62" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#f8TlGPwTJ" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#f8TlGPwTJ" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="3" on:click={() => selectedToothIso(63)}>
											<g>
													<use xlink:href="#iso-63" fill={tl.conditionToColor( tl.getByIso(63))} />
													<g>
															<use xlink:href="#iso-63" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#a4D4emNiDi" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#a4D4emNiDi" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="4" on:click={() => selectedToothIso(64)}>
											<g>
													<use xlink:href="#iso-64" fill={tl.conditionToColor( tl.getByIso(64))} />
													<g>
															<use xlink:href="#iso-64" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#g9i5HslOD" opacity="1" fill="#000" />
													<g>
															<use xlink:href="#g9i5HslOD" fill-opacity="0" stroke="#000" stroke-width="0" >
													</g>
											</g>
									</g>
									<g class="5" on:click={() => selectedToothIso(65)}>
											<g>
													<use xlink:href="#iso-65" fill={tl.conditionToColor( tl.getByIso(65))} />
													<g>
															<use xlink:href="#iso-65" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#d9AQUN9l" opacity="1" fill="#000" />
													<g>
															<use xlink:href="#d9AQUN9l" fill-opacity="0" stroke="#000" stroke-width="0" >
													</g>
											</g>
									</g>
									<g class="text">
											<g id="d2U4NC4l2h">
													<use xlink:href="#a3vLld1187" opacity="1" fill="#000" />
											</g>
											<g id="chkNbUqVc">
													<use xlink:href="#d8C077TiQe" opacity="1" fill="#000" />
											</g>
											<g id="e29QMOL8fU">
													<use xlink:href="#a3dsbSynl2" opacity="1" fill="#000" />
											</g>
											<g id="a2UkPZ9kt7">
													<use xlink:href="#c3i2cqy5i8" opacity="1" fill="#000" />
											</g>
											<g id="b1ItOC0t1y">
													<use xlink:href="#c2Gq2EB8T" opacity="1" fill="#000" />
											</g>
									</g>
							</g>
							<g class="q7">
									<g class="1" on:click={() => selectedToothIso(71)}>
											<g>
													<use xlink:href="#iso-71" fill={tl.conditionToColor( tl.getByIso(71))} />
													<g>
															<use xlink:href="#iso-71" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#f1SexwZEcq" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#f1SexwZEcq" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="2" on:click={() => selectedToothIso(72)}>
											<g>
													<use xlink:href="#iso-72" fill={tl.conditionToColor( tl.getByIso(72))} />
													<g>
															<use xlink:href="#iso-72" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#b9tcVaTZ" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#b9tcVaTZ" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="3" on:click={() => selectedToothIso(73)}>
											<g>
													<use xlink:href="#iso-73" fill={tl.conditionToColor( tl.getByIso(73))} />
													<g>
															<use xlink:href="#iso-73" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#hdg0tmh2L" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#hdg0tmh2L" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="4" on:click={() => selectedToothIso(74)}>
											<g>
													<use xlink:href="#iso-74" fill={tl.conditionToColor( tl.getByIso(74))} />
													<g>
															<use xlink:href="#iso-74" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#a4VwzCcbws" opacity="1" fill="#000" />
													<g>
															<use xlink:href="#a4VwzCcbws" fill-opacity="0" stroke="#000" stroke-width="0" >
													</g>
											</g>
									</g>
									<g class="5" on:click={() => selectedToothIso(75)}>
											<g>
													<use xlink:href="#iso-75" fill={tl.conditionToColor( tl.getByIso(75))} />
													<g>
															<use xlink:href="#iso-75" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#h46WoT2rhW" opacity="1" fill="#000" />
													<g>
															<use xlink:href="#h46WoT2rhW" fill-opacity="0" stroke="#000" stroke-width="0" >
													</g>
											</g>
									</g>
									<g class="text">
											<g id="bbGVcBKeK">
													<use xlink:href="#a253G7JNHZ" opacity="1" fill="#000" />
											</g>
											<g id="a2LizwfKkt">
													<use xlink:href="#dgSWNXQt1" opacity="1" fill="#000" />
											</g>
											<g id="a1dli2uYZu">
													<use xlink:href="#b1fKZ8Bv2u" opacity="1" fill="#000" />
											</g>
											<g id="aCcMzwUXK">
													<use xlink:href="#b83Atca9Z" opacity="1" fill="#000" />
											</g>
											<g id="b1Rz4H5VcT">
													<use xlink:href="#hfHo0NDB3" opacity="1" fill="#000" />
											</g>
									</g>
							</g>
							<g class="q8">
									<g class="1" on:click={() => selectedToothIso(81)}>
											<g>
													<use xlink:href="#iso-81" fill={tl.conditionToColor( tl.getByIso(81))} />
													<g>
															<use xlink:href="#iso-81" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#baO5m8gAJ" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#baO5m8gAJ" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="2" on:click={() => selectedToothIso(82)}>
											<g>
													<use xlink:href="#iso-82" fill={tl.conditionToColor( tl.getByIso(82))} />
													<g>
															<use xlink:href="#iso-82" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#b1OuMQtEP6" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#b1OuMQtEP6" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="3" on:click={() => selectedToothIso(83)}>
											<g>
													<use xlink:href="#iso-83" fill={tl.conditionToColor( tl.getByIso(83))} />
													<g>
															<use xlink:href="#iso-83" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#b2roP7vEXi" opacity="1" fill-opacity="0" />
													<g>
															<use xlink:href="#b2roP7vEXi" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
									</g>
									<g class="4" on:click={() => selectedToothIso(84)}>
											<g>
													<use xlink:href="#iso-84" fill={tl.conditionToColor( tl.getByIso(84))} />
													<g>
															<use xlink:href="#iso-84" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#a5EcJWHaOD" opacity="1" fill="#000" />
													<g>
															<use xlink:href="#a5EcJWHaOD" fill-opacity="0" stroke="#000" stroke-width="0" >
													</g>
											</g>
									</g>
									<g class="5" on:click={() => selectedToothIso(85)}>
											<g>
													<use xlink:href="#iso-85" fill={tl.conditionToColor( tl.getByIso(85))} />
													<g>
															<use xlink:href="#iso-85" fill-opacity="0" stroke="#000" stroke-width="2" >
													</g>
											</g>
											<g>
													<use xlink:href="#avxQ9BjFX" opacity="1" fill="#000" />
													<g>
															<use xlink:href="#avxQ9BjFX" fill-opacity="0" stroke="#000" stroke-width="0" >
													</g>
											</g>
									</g>
									<g class="text">
											<g id="e17J4GcJHT">
													<use xlink:href="#a1jKNA7rAN" opacity="1" fill="#000" />
											</g>
											<g id="a1vZchl36W">
													<use xlink:href="#aAHeijBe5" opacity="1" fill="#000" />
											</g>
											<g id="a1LXneLur">
													<use xlink:href="#ek5cw6Hgp" opacity="1" fill="#000" />
											</g>
											<g id="btsq7lcvc">
													<use xlink:href="#g2rNJx6rxS" opacity="1" fill="#000" />
											</g>
											<g id="dber0XavM">
													<use xlink:href="#d14UMdDj6N" opacity="1" fill="#000" />
											</g>
									</g>
							</g>
					</g>
	...
	<div class="pt-28">
			<p>FORM GOES HERE</p>
			<!-- <gita-tooth-form [mode]="'deciduous'"></gita-tooth-form> -->
	</div>
</div>
<span class="uppercase">Tooth </span> 
{#key toothIndex}
	(<span class="font-bold">{toothIndex}: {currentTooth()}</span>)
{/key}
